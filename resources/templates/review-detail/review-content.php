  ...
  <div class="r_rdw-main_content">
      <?php if ($reviewObj->hasImages()): ?>
        <div class="r_rdw-image-container">
          <div class="r_rdw_all_images <?php echo count($reviewObj->getReviewImages() ) == 1? 'r_rdw_single_image_container' : 'r_rdw_multi_image_container' ?> ">
    ...
    <div class="r_rdw-detail-wrapper">
      <div class="r_rdw-review-details">
        <div class="r_rdw-spread-container">
          ...
          <div class="r_rdw-overview">
            ...
            <div class="r_rdw-i-verified-notification"><span>Verified user</span>
            </div>
          </div>
        </div>
        <div class="r_rdw-spread-container">
            <?php if ($reviewObj->isRatingGiven()): ?>
              <div class="r_rdw-review-icons">
                  <?php foreach (range(0, 4) as $index) { ?>
                    <i
                      class="farp farp-<?php echo $index < $reviewObj->getRatting() ? $data['ratings']['rating_icon'] : $data['ratings']['rating_outline_icon']; ?>"></i>
                  <?php } ?>
              </div>
            <?php endif ?>
        </div>
      ...
      <div class="r_rdw-review-content-wrapper">
        ...
        <div class="r_rdw-spread-container__review-date r_rdw-review-posted-date">Posted
          on <?php echo esc_attr($reviewObj->getReviewDate()) ?></div>
          <?php foreach ($reviewObj->getReplies() as $reply) : ?>
            <div class="r_rdw-review-item-reply">
              <div class="r_rdw-item-reply-title"><strong
                  class="r_rdw-small-text r_rdw-font-weight-bold"><?php echo esc_html__($reply->getReviewerName()) ?></strong>
                  <span class="r_rdw-reply-date">
                     22-22-2022
                  </span>
              </div>
