<div class="r_pw_mh_container">
    <div class="r_pw_header_rating_container r_pw_mh_rating_container">
        <div class="r_pw_mh_rating_details">
            <i class="review review-gem review-icon-filled "
        ...
        <div class="r_pw_mh_overall_reviews"><span class="r_pw_mh_overall_reviews_count">20 Reviews</span><span
                    class="r_pw_mh_filter_open_icon"><svg width="14" height="8" viewBox="0 0 14 8" fill="none"
                                                          xmlns="http://www.w3.org/2000/svg" aria-label="chevron open"
                                                          role="img" class="chevron-open"><path
                            d="M7.11098 5.15691L2.16098 0.206909L0.746979 1.62091L7.11098 7.98491L13.475 1.62091L12.061 0.206911L7.11098 5.15691Z"
                            fill="black"></path></svg></span><span class="r_pw_mh_filter_close_icon"><svg width="14"
                                                                                                          height="8"
                                                                                                          viewBox="0 0 14 8"
                                                                                                          fill="none"
                                                                                                          xmlns="http://www.w3.org/2000/svg"
                                                                                                          aria-label="chevron closed"
                                                                                                          role="img"
                                                                                                          class="chevron-closed chevron-hide"><path
                            d="M6.88902 3.03498L11.839 7.98499L13.253 6.57099L6.88902 0.206985L0.525021 6.57098L1.93902 7.98498L6.88902 3.03498Z"
    ...
    <div class="r_pw_mh_actions_container">
        ...
        <div class="r_pw_mh_actions_container--sorting_container">
            <button type="button" class="r_pw_header_button r_pw_mh_actions_container--sorting_container-btn">
                <svg data-panel="dropdown" id="menu-icon-svg" width="20" height="21" viewBox="0 0 20 21" fill="none"
                     xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Sort reviews by menu">
