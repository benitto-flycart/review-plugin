<div class="r_pw_ch_container">
    <div class="r_pw_ch_rating_container" style="color: rgb(40, 40, 40);">
        <div class="r_pw_ch_rating"><i class="review-icon review review-gem review-icon-filled "
                                       style="font-size: inherit; color: inherit;"></i><span>4.7</span></div>
        <span>20 Reviews</span></div>
    <div class="r_pw_ch_rd_container" style="color: rgb(40, 40, 40);">
        <div class="r_pw_ch_rd_detail">
            <div class="r_pw_ch_rd_detail_icon"><i class="review-icon review review-gem review-icon-filled "
            ...
            <div class="r_pw_ch_rd_detail_progress_bar">
                <div style="height: 100%; width: 100%; background-color: rgb(245, 245, 245); border-radius: 50px;">
                    <div style="height: 100%; width: 33%; background-color: rgb(123, 123, 123); border-radius: inherit; text-align: right;">
                        <span style="padding: 5px; color: white; font-weight: bold;"></span></div>
                </div>
            </div>
            <div class="r_pw_ch_rd_detail_progress_bar_count">14</div>
        </div>
        <div class="r_pw_ch_rd_detail">
            <div class="r_pw_ch_rd_detail_icon"><i class="review-icon review review-gem review-icon-filled "
                                                   style="font-size: inherit; color: inherit;"></i><i
    ...
    <div class="r_pw_ch_actions">
        <div class="r_pw_ch_actions_new_review_btn_container">
            <button type="button" class="r_pw_ch_actions_new_review_btn_container_btn"
                    style="color: rgb(0, 0, 0); background-color: rgb(255, 255, 255); border-color: rgb(232, 232, 232);">
                Write a Review
            </button>
        </div>
        <div class="r_pw_ch_actions_sorting_container">
            <div class="r_pw_h_popover-container">
                <button class="r_pw_h_popover-trigger" aria-haspopup="true" aria-expanded="false"
                        aria-controls="popover-content">
                    <button type="button" class="r_pw_ch_actions_sorting_container_btn"
                            style="color: rgb(0, 0, 0); background-color: rgb(255, 255, 255); border-color: rgb(232, 232, 232);">
