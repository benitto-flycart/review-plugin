<div class="r_pw_ch_container">
    ...
    <div class="r_pw_ch_actions">
        <div class="r_pw_ch_actions_new_review_btn_container">
            <button type="button" class="r_pw_ch_actions_new_review_btn_container_btn">Write a Review</button>
        </div>
        <div class="r_pw_ch_actions_sorting_container">
            <div class="r_pw_h_popover-container"><span class="r_pw_h_popover-trigger" aria-haspopup="true"
                                                        aria-expanded="false" aria-controls="popover-content"><button
                            type="button" class="r_pw_ch_actions_sorting_container_btn"><svg data-panel="dropdown"
                                                                                             id="menu-icon-svg"
                                                                                             width="20" height="21"
                                                                                             viewBox="0 0 20 21"
                                                                                             fill="none"
                                                                                             ...
                                                                                             role="img"
                                                                                             aria-label="Sort reviews by menu"><path
                                    id="menu-btn-path" data-panel="dropdown"
                                    ...
                                    fill="black"></path></svg></button></span></div>
        </div>
    </div>
</div>