...
export const ReviewRatings = <T extends ReviewRatingsPropType>({ reviewState, reviewLoading, includeMetaData }: T) => {
    ...
    <div className="frt-flex frt-flex-col frt-gap-6 frt-mb-6 md:frt-h-max md:frt-w-[20%]">
      <Card className="frt-flex-1">
        <CardContent className="frt-pt-6">
          {
            reviewLoading && includeMetaData ? <div className={"frt-h-[167px]"}><LoadingSpinner /></div> : <>
              <div
              ...
              <div
                className="frt-text-center frt-text-gray-600">{reviewState.total_review_count} Reviews
              </div>
            </>
          }
        </CardContent>
