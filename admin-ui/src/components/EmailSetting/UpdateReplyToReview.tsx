    ...
    axiosClient
      ...
      .then((response: any) => {
        ...
        setState({
          ...
          subject_placholder: data.placeholders.subject,
          body_placholder: data.placeholders.body,
        });
              ...
              <div className="frt-grid frt-gap-3">
                ...
                <div className={"frt-flex frt-flex-col frt-gap-y-2"}>
                  <div className={"frt-flex frt-flex-col frt-gap-y-1"}>
                    <Input
                      type="text"
                      placeholder={state.subject_placholder}
                      value={state.subject}
                      onChange={(e: any) => {
                ...
                <div className={"frt-flex frt-flex-col frt-gap-y-2"}>
                  <div className={"frt-flex frt-flex-col frt-gap-y-1"}>
                    <Textarea
                      ...
                      placeholder={state.body_placholder}
                      value={state.body}
                    ></Textarea>
