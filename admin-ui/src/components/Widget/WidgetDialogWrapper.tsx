...
const WidgetDialogWrapper = ({
  ...
  return (
    <Dialog open={show} onOpenChange={toggle}>
      <DialogContent
        className={
          "wd_container widget_snippet review-widget-preview !frt-p-0 !frt-gap-0"
        }
      ...
      >
        ...
        <Button
          className={
            "frt-absolute frt-flex frt-gap-x-1 frt-right-10 frt-bottom-10"
          }
          onClick={context.methods.saveSettings}
        >
