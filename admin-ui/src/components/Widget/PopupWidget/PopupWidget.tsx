...
import PopupWidgetContextAPI from "./PopupWidgetContextAPI";
import PopupWidgetDialog from "./PopupWidgetDialog";
...
const PopupWidget = () => {
    ...
    return (
        <div className="frt-w-3/4 frt-mx-auto frt-my-4">
            ...
            {uiConfig ? (<PopupWidgetContextAPI>
                <PopupWidgetDialog show={uiConfig} toggle={setUiConfig}/>
