...
export const FloatingProductReviewsWidget = () => {
  ...
  const schema = yup.object().shape({
    ...
    product_thumbnail_enabled: yup
      .boolean()
      .required("Product thumbnail enabled is required"),
    link_to_product_page_enabled: yup
      .boolean()
      .required("Link to product enabled is required"),
  });
              ...
              {loading ? (
                ...
                <>
                  <div className=" frt-flex frt-flex-col frt-gap-y-2 frt-border-b frt-border-gray-300 frt-pb-4">
                    <div className=" frt-flex frt-flex-col frt-gap-y-2">
                      <div className=" frt-flex frt-gap-x-2">
                        <h4 className="frt-font-bold frt-text-lg">
                          Floating Product Reviews Widget
                        </h4>
                        <Badge>Learn more</Badge>
                      </div>
                      <span className={"frt-text-grayprimary"}>
                        Present your reviews on a floating display so users can
                        browse through reviews without leaving the page they are
                        currently on.
                      </span>
                    </div>
                    <div
                      className={
                        "frt-grid frt-justify-between frt-grid-cols-[30%_70%]"
                      }
                    >
                      <h4 className="frt-font-bold frt-text-sm">
                        Activate Widget
                      </h4>
                      <Switch
                        id="activate-widget"
                  ...
                  <div className="frt-flex frt-gap-x-6">
                    <div
                      className={
                        "frt-flex frt-w-70% frt-flex-col frt-gap-y-4 frt-my-6"
                      }
                    >
                      <FormField
                            ...
                            <div className="frt-grid frt-grid-cols-[30%_70%]">
                              ...
                              <div>
                                <FormControl>
                                  <div
                                    className={
                                      "frt-grid frt-grid-flow-col frt-grid-cols-[85%_15%]"
                                    }
                                  >
                                    <Input
                                      type={"text"}
                    ...
                    <div className="frt-w-30% frt-my-6 frt-flex frt-flex-col frt-gap-y-4">
                      ...
                      <div className={"frt-flex frt-flex-col frt-gap-y-3"}>
                        ...
                        <div className="frt-flex frt-gap-x-2">
                          <Switch
                            id="link_to_product_page_enabled"
                            checked={values.link_to_product_page_enabled}
                            onCheckedChange={(value: boolean) => {
                              form.setValue(
                                "link_to_product_page_enabled",
                                value,
                              );
                            }}
                          />
