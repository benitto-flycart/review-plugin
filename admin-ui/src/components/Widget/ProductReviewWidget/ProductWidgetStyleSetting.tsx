...
const ProductWidgetStyleSetting = () => {
    ...
    return (
        <div className={"frt-flex frt-flex-col frt-divide-y frt-divide-black-400 frt-gap-2 "}>
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Review Card Shadow</span>
                </div>
                    ...
                    >
                        ...
                        <div>
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg" className="_svg_e99jr_1 _svg__classic_e99jr_5">
                    ...
                    >
                        ...
                        <div>
                            <svg
                                ...
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" className="_svg_e99jr_1 _svg__light_e99jr_11">
                                <rect x="0.5" y="0.5" width="23" height="23" rx="3.5" fill="white"
                                      stroke="#DCE3E9"></rect>
                            </svg>
                        </div>
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Review Card Openers</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2"}>
                    <div
                        className={"frt-cursor-pointer frt-rounded-xl frt-h-[100px] frt-text-center frt-border frt-border-black-100 frt-border-collapse frt-flex frt-flex-col frt-justify-center frt-items-center frt-gap-2"}
