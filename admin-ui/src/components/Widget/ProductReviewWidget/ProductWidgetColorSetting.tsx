...
const ProductWidgetColorSetting = () => {
    ...
    return (
        <div className={"frt-flex frt-flex-col frt-divide-y frt-divide-black-400"}>
            <div className={"frt-flex frt-justify-between frt-p-4 widget-header-title"}>
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Widget Colors</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2"}>
                    ...
                    >
                        <div className={"frt-flex frt-gap-1"}>
                            <Checkbox checked={widget.colors.type == 'dark_text'}
                                      value={"dark_text"}/>
                            <Label className={"frt-text-xs"} htmlFor="none">Dark Text</Label>
                        </div>
                        <div>
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" className="_svg_ebs72_1">
                    ...
                    >
                        <div className={"frt-flex frt-gap-1"}>
                            <Checkbox checked={widget.colors.type == 'light_text'}
                                      value={"light_text"}/>
                            <Label className={"frt-text-xs"} htmlFor="light_text">Light Text</Label>
                        </div>
                        <div>
                                ...
                                <g clip-path="url(#clip0_5848_86970)">
                                    ...
                                    <g style={{mixBlendMode: "hard-light"}}>
                                        ...
                                        <g filter="url(#filter12_f_5848_86970)">
                                            <ellipse cx="4.2256" cy="10.26" rx="4.2256" ry="10.26"
                                ...
                                <defs>
                                    <filter id="filter0_b_5848_86970" x="-4" y="-4" width="32" height="32"
                                        ...
                                        <feComposite in2="SourceAlpha" operator="in"
                                                     result="effect1_backgroundBlur_5848_86970"></feComposite>
                                        <feBlend mode="normal" in="SourceGraphic"
                                                 in2="effect1_backgroundBlur_5848_86970" result="shape"></feBlend>
                                    </filter>
                                    <filter id="filter1_f_5848_86970" x="-15.8823" y="-11.8046" width="27.481"
                                        ...
                                        <feGaussianBlur stdDeviation="4.47507"
                                                        result="effect1_foregroundBlur_5848_86970"></feGaussianBlur>
                                    </filter>
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Header</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2 frt-justify-center"}>
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Text & Icon Color</Label>
                        <PopOverColorPicker color={colors.header.text_and_icon_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Bar Fill</Label>
                        <PopOverColorPicker color={colors.header.bar_fill_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Bar background</Label>
                        <PopOverColorPicker color={colors.header.bar_bg_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Buttons</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2 frt-justify-center"}>
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Text </Label>
                        <PopOverColorPicker color={colors.button.text_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Text Hover</Label>
                        <PopOverColorPicker color={colors.button.text_hover_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        ...
                        <PopOverColorPicker color={colors.button.bg_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Background Hover</Label>
                        <PopOverColorPicker color={colors.button.bg_hover_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Border</Label>
                        <PopOverColorPicker color={colors.button.border_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Reviews</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2 frt-justify-center"}>

                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Text</Label>
                        <PopOverColorPicker color={colors.reviews.text_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Background</Label>
                        <PopOverColorPicker color={colors.reviews.bg_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Background Hover</Label>
                        <PopOverColorPicker color={colors.reviews.bg_hover_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Replies</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2 frt-justify-center"}>

                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Text</Label>
                        <PopOverColorPicker color={colors.replies.text_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
                    ...
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Background</Label>
                        <PopOverColorPicker color={colors.replies.bg_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Verified Badge</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2 frt-justify-center"}>
                    <div className={"frt-flex frt-flex-col frt-gap-2"}>
                        <Label className={"frt-text-xs"} htmlFor="none">Icon Color</Label>
                        <PopOverColorPicker color={colors.verified_badge.icon_color} onChange={(color: string) => {
                            updateWidgetFields((draftState: any) => {
                                draftState.colors.type = 'custom'
