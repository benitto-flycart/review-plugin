  ...
  return (
    <div className={"r_pw_ch_container"}>
      ...
      {methods.isRatingOptionsEnabled() ? (
        <div
          className={
            "r_pw_ratings-row-progress-bar-details r_pw_ch_rd_container"
          }
        >
          {review_details.map((detail: any, rating: number) => (
            <div key={rating} className={"r_pw_h_rd_detail r_pw_ch_rd_detail"}>
              ...
              <div className={"r_pw_ch_rd_detail_progress_bar_count"}>
                {detail.count}
              </div>
            </div>
          ))}
      ...
      <div className={"r_pw_ch_actions"}>
        {methods.isAddReviewEnabled() ? (
          <div className={"r_pw_ch_actions_new_review_btn_container"}>
            <button
              type="button"
        ...
        {methods.isSortingEnabled() ? (
          <div className={"r_pw_ch_actions_sorting_container"}>
            <CustomPopover
              content={
                <div>
                  <ul>
