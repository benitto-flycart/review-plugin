                            ...
                            <div
                                ...
                                <div>
                                    <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                        ...
                                        <rect x="8" y="8" width="11.751" height="16.5129" rx="1"
                                        ...
                                        <rect x="22.689" y="8" width="11.751" height="14.154" rx="1"
                                              fill="currentColor"></rect>
                                        ...
                                        <path
                                            ...
                                            fill="currentColor"></path>
                                        <rect x="52.249" y="8" width="11.751" height="14.154" rx="1"
                                              fill="currentColor"></rect>
                                ...
                                <div>
                                    <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_6002_86738)">
                                            <rect x="11" y="11" width="24" height="16" rx="1"
                                                  fill="currentColor"></rect>
                                        ...
                                        <g clip-path="url(#clip1_6002_86738)">
                                            <rect x="38" y="11" width="24" height="8" rx="1.06262"
                                                  fill="currentColor"></rect>
                                            <rect x="38" y="21.5" width="24" height="24" rx="1.06262"
                                                  fill="currentColor"></rect>
                                            <rect x="38" y="48" width="24" height="16" rx="1.06262"
                                                  fill="currentColor"></rect>
                                        </g>
                                        <defs>
                                            ...
                                            <clipPath id="clip1_6002_86738">
                                                <rect width="24" height="45" fill="white"
                                                      transform="translate(38 11)"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </div>
                                ...
                                <div>
                                    <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="currentColor"></path>
                                        <g opacity="0.5">
                                            <rect x="48" y="20" width="17" height="12" rx="1"
                                                  fill="currentColor"></rect>
                                        </g>
                                    </svg>
                                </div>
