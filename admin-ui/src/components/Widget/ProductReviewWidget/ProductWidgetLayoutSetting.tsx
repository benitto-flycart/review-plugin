...
const ProductWidgetLayoutSetting = () => {
    const {widget, updateWidgetFields} = useContext<any>(ProductWidgetContext)

    return (
        <div className={"frt-flex frt-flex-col frt-divide-y frt-divide-black-400"}>
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Widget Layout</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2"}>
                    <div
                        ...
                        <div className="frt-flex frt-items-start frt-space-x-2">
                            <Checkbox checked={widget.layout.widget_layout == 'grid'} value={"grid"}/>
                            <Label className={"frt-text-xs"} htmlFor="widget-layout-list">Grid</Label>
                        </div>
                        <div>
                            <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" className="_svg_1cuzs_1">
                                <rect opacity="0.1" width="72" height="56" rx="2" fill="currentColor"></rect>
                                <rect x="8" y="8" width="11.751" height="16.5129" rx="1" fill="currentColor"></rect>
                                <rect x="8" y="26.8721" width="11.751" height="16.5129" rx="1"
                                      fill="currentColor"></rect>
                                <path d="M8 47C8 46.4477 8.44772 46 9 46H19C19.5523 46 20 46.4477 20 47V56H8V47Z"
                                      fill="currentColor"></path>
                                <rect x="22.689" y="8" width="11.751" height="14.154" rx="1" fill="currentColor"></rect>
                                <rect x="22.689" y="24.5127" width="11.751" height="14.154" rx="1"
                                      fill="currentColor"></rect>
                                <path d="M23 42C23 41.4477 23.4477 41 24 41H33C33.5523 41 34 41.4477 34 42V56H23V42Z"
                                      fill="currentColor"></path>
                                <rect x="37.5601" y="8" width="11.751" height="16.5129" rx="1"
                                      fill="currentColor"></rect>
                                <rect x="37.5603" y="26.8721" width="11.751" height="16.5129" rx="1"
                                      fill="currentColor"></rect>
                                <path d="M38 47C38 46.4477 38.4477 46 39 46H48C48.5523 46 49 46.4477 49 47V56H38V47Z"
                                      fill="currentColor"></path>
                                <rect x="52.249" y="8" width="11.751" height="14.154" rx="1" fill="currentColor"></rect>
                                <rect x="52.249" y="24.5137" width="11.751" height="14.154" rx="1"
                                      fill="currentColor"></rect>
                                <path d="M52 42C52 41.4477 52.4477 41 53 41H63C63.5523 41 64 41.4477 64 42V56H52V42Z"
                                      fill="currentColor"></path>
                            </svg>
                        </div>
                    </div>
                    ...
                    >
                        <div className="frt-flex frt-items-start frt-space-x-2">
                            <Checkbox checked={widget.layout.widget_layout == 'list'} value={"list"}/>
                            <Label className={"frt-text-xs"} htmlFor="widget-layout-list">List</Label>
                        </div>
                        <div>
                            <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg"
                                 className="_svg_1cuzs_1">
                                <rect opacity="0.8" width="72" height="56" rx="2" fill="#EFF1F4"></rect>
                                <rect x="10" y="12" width="52" height="16" rx="2" fill="currentColor"></rect>
                                <rect x="10" y="30" width="52" height="16" rx="2" fill="currentColor"></rect>
                                <path d="M10 50C10 48.8954 10.8954 48 12 48H60C61.1046 48 62 48.8954 62 50V56H10V50Z"
                                      fill="currentColor"></path>
                            </svg>
                        </div>
                    </div>
                    <div
                        className={"frt-cursor-pointer frt-rounded-xl frt-h-[100px] frt-text-center frt-border frt-border-black-100 frt-border-collapse frt-flex frt-flex-col frt-justify-center frt-items-center frt-gap-2k"}
                        onClick={() => {
                            updateWidgetFields((draftState: any) => {
                    ...
                    >
                        <div className="frt-flex frt-items-start frt-space-x-2">
                            <Checkbox checked={widget.layout.widget_layout == 'mosaic'}
                                      value={"mosaic"}/>
                            <Label className={"frt-text-xs"} htmlFor="widget-layout-list">Mosaic</Label>
                        </div>
                        <div>
                            <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg"
                                 className="_svg_1cuzs_1">
                                <rect opacity="0.8" width="72" height="56" rx="2" fill="#EFF1F4"></rect>
                                <g clip-path="url(#clip0_6002_86738)">
                                    <rect x="11" y="11" width="24" height="16" rx="1" fill="currentColor"></rect>
                                    <rect x="11" y="29.5" width="24" height="18" rx="1.06262"
                                          fill="currentColor"></rect>
                                    <rect x="11" y="50" width="24" height="15.68" rx="1.06262"
                                          fill="currentColor"></rect>
                                </g>
                                <g clip-path="url(#clip1_6002_86738)">
                                    <rect x="38" y="11" width="24" height="8" rx="1.06262" fill="currentColor"></rect>
                                    <rect x="38" y="21.5" width="24" height="24" rx="1.06262"
                                          fill="currentColor"></rect>
                                    <rect x="38" y="48" width="24" height="16" rx="1.06262" fill="currentColor"></rect>
                                </g>
                                <defs>
                                    <clipPath id="clip0_6002_86738">
                                        <rect width="24" height="45" fill="white" transform="translate(11 11)"></rect>
                                    </clipPath>
                                    <clipPath id="clip1_6002_86738">
                                        <rect width="24" height="45" fill="white" transform="translate(38 11)"></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
            ...
            <div className={"frt-flex frt-flex-col frt-gap-2 frt-p-4"}>
                <div>
                    <span className={"frt-font-extrabold"}>Header Layout</span>
                </div>
                <div className={"frt-grid frt-grid-cols-2 frt-gap-2"}>
                    <div
                        className={"frt-cursor-pointer frt-rounded-xl frt-h-[100px] frt-text-center frt-border frt-border-black-100 frt-border-collapse frt-flex frt-flex-col frt-justify-center frt-items-center frt-gap-2"}
                    ...
                    >
                        <div className="frt-flex frt-items-start frt-space-x-2">
                            <Checkbox checked={widget.layout.header_layout == 'minimal'}
                                      value={"minimal"}/>
                            <Label className={"frt-text-xs"} htmlFor="header-minimal-list">Minimal</Label>
                        </div>
                        <div>
                            <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" className="_svg_1cuzs_1">
                                <rect opacity="0.8" width="72" height="56" rx="2" fill="#EFF1F4"></rect>
                                <rect opacity="0.5" x="54" y="14" width="12" height="4" rx="1"
                                      fill="currentColor"></rect>
                                <path
                    ...
                    >
                        <div className="frt-flex frt-items-start frt-space-x-2">
                            <Checkbox checked={widget.layout.header_layout == 'compact'}
                                      value={"compact"}/>
                            <Label className={"frt-text-xs"} htmlFor="header-compact-list">Compact</Label>
                        </div>
                        <div>
                            <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" className="_svg_1cuzs_1">
                    ...
                    >
                        <div className="frt-flex frt-items-start frt-space-x-2">
                            <Checkbox checked={widget.layout.header_layout == 'expanded'}
                                      value={"expanded"}/>
                            <Label className={"frt-text-xs"} htmlFor="header-expanded-list">Expanded</Label>
                        </div>
                        <div>
                            <svg width="72" height="56" viewBox="0 0 72 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg" className="_svg_1cuzs_1">
                                ...
                                <path
                                    ...
                                    fill="currentColor"></path>
                                <g opacity="0.5">
                                    <rect x="48" y="20" width="17" height="12" rx="1" fill="currentColor"></rect>
                                </g>
                            </svg>
                        </div>
                    </div>
