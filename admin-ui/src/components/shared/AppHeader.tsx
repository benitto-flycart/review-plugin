...
import '@/src/styles/dashboard/app-header.css'

const AppHeader: FC = () => {
    const {localState} = useLocalState();
    return (
        <div
            className="relay-wp-app-header frt-full relay-wp-h-14 frt-border-white frt-flex frt-justify-between frt-items-center relay-wp-px-3 ">
            <div className='frt-ml-3'>
                <span className='frt-flex frt-justify-between frt-items-center frt-gap-2'>
                ...
                <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <span className='frt-text-4xl frt-text-black frt-font-bold'>{localState.plugin_name}</span>
                </span>
            </div>
