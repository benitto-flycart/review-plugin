...
const AppHeader: FC = () => {
  ...
  return (
    <div className="relay-wp-app-header frt-full relay-wp-h-14 frt-border-white frt-flex frt-justify-between frt-items-center relay-wp-px-3 ">
      <div className="frt-ml-3">
        <span className="frt-flex frt-justify-between frt-items-center frt-gap-2">
          ...
          <span className="frt-text-4xl frt-text-black frt-font-bold">
            {localState.plugin_name}
          </span>
        </span>
      </div>
