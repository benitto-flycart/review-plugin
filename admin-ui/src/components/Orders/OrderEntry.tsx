...
export const OrderEntry=<T extends OrderEntryProps>({order,fetchOrders}:T)=>{
                        ...
                        <div className="frt-grid frt-grid-cols-[1fr,auto] frt-gap-4">
                            <div className="frt-p-6 frt-space-y-4">
                                <div className="frt-flex frt-justify-between frt-items-center">
                                    ...
                                    <div
                                        className=" frt-flex frt-justify-start frt-items-center">
                                        <a href={order.order_url} className="frt-whitespace-nowrap frt-flex frt-items-center frt-mr-[10px] frt-border-r frt-border-r-gray-300 frt-border-solid frt-pr-[10px] frt-cursor-pointer frt-text-sm frt-font-normal">
                                            <ShoppingCart className="frt-h-4 frt-w-4 frt-mr-2"/>
                                            Go to order
                                        </a>
                                        { areAllEmailsSent() ? <a onClick={sendMail}
                                            ...
                                            {loading ? <LoadingSpinner/>:<Send className="frt-h-4 frt-w-4 frt-mr-2"/>}
                                            Send now
                                        </a> : null}
