                                    ...
                                    render={({field}) => (
                                        <FormItem>
                                            <FormControl className="frt-w-1/4">
                                                <Input type={"color"} value={values.rating_rgb_color}
                                                       onChange={(e: any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <Switch id="review-branding"
                                                        defaultChecked={values.enable_review_branding}
                                                        onCheckedChange={(value: any) => {
                                                            console.log(value);
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <FormControl>
                                                <Switch
                                                    id="email-banners"
                                                    defaultChecked={values.enable_email_banners}
                                                    onCheckedChange={(value: any) => {
                            ...
                            render={({field}) => (
                                <FormItem className="frt-m-2 rwt-my-2">
                                    <div
                                        ...
                                        <div>
                                            <FormControl>
                                                <Select defaultValue={values.appearance}
                                                        onValueChange={(value: string) => {
                                                            console.log('Changing Apperance');
                                                            console.log(value)
                                        ...
                                        <div>
                                            <FormControl>
                                                <div className="frt-flex frt-justify-items-start frt-gap-2">
                                                    <span>#</span>
                                                    <input type="color"
                                                           defaultValue={values.appearance_options.email_background_color}
                                                           onChange={(e: any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <div className="frt-flex frt-justify-items-start frt-gap-2">
                                                    <span>#</span>
                                                    <input type="color"
                                                           defaultValue={values.appearance_options.content_background_color}
                                                           onChange={(e: any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <div className="frt-flex frt-justify-items-start frt-gap-2">
                                                    <span>#</span>
                                                    <input type="color"
                                                           defaultValue={values.appearance_options.email_text_color}
                                                           onChange={(e: any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <div className="frt-flex frt-justify-items-start frt-gap-2">
                                                    <span>#</span>
                                                    <input type="color"
                                                           defaultValue={values.appearance_options.button_bg_color}
                                                           onChange={(e: any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <div className="frt-flex frt-justify-items-start frt-gap-2">
                                                    <span>#</span>
                                                    <input type="color"
                                                           defaultValue={values.appearance_options.button_border_color}
                                                           onChange={(e: any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <div className="frt-flex frt-justify-items-start frt-gap-2">
                                                    <span>#</span>
                                                    <input type="color"
                                                           defaultValue={values.appearance_options.button_title_color}
                                                           onChange={(e: any) => {
                                ...
                                <FormItem className="frt-m-2 rwt-my-2">
                                    <div
                                        ...
                                        <div>
                                            <FormControl>
                                                <Select
                                                    defaultValue={values.appearance_options.font_type}
                                                    onValueChange={(value: string) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <Input
                                                    ...
                                                    defaultValue={values.appearance_options.font_size}
                                                    onChange={(e) => {
