                                        ...
                                        <div>
                                            <FormControl>
                                                <Switch
                                                    ...
                                                    defaultChecked={values.enable_photo_discount}
                                                    onCheckedChange={(value: boolean) => {
                                                        form.setValue('enable_photo_discount', value)
                                                    }}
                                                />
                                            </FormControl>
                                            <FormDescription>Incentivize customers to leave a photo review by offering a
                            ...
                            render={({field}) => (
                                <FormItem className="frt-m-2 rwt-my-2">
                                    <div
                                        ...
                                        <div>
                                            <FormControl>
                                                <Select defaultValue={values.photo_discount_type}>
                                        ...
                                        <div>
                                            <FormControl>
                                                <Input type="number" placeholder="Value"
                                                       defaultValue={values.photo_discount_value}
                                                       onChange={(e:any) => {
                                        ...
                                        <div>
                                            <FormControl>
                                                <Switch id="enable_video_discount"
                                                        defaultChecked={values.enable_video_discount}
                                                        onCheckedChange={(value: boolean) => {
                                                            form.setValue('enable_video_discount', value)
                                                        }}
                                                />
                                            </FormControl>
                                            <FormDescription>Incentivize customers to leave a Video review by offering a
                                                discount for their next purchase</FormDescription>
                                            <FormMessage/>
                                        </div>
                                    </div>
                                ...
                                <FormItem className="frt-m-2 rwt-my-2">
                                    <div
                                        ...
                                        <div>
                                            <FormControl>
                                                <Select
                                                    defaultValue={values.video_discount_type}
                                ...
                                <FormItem className="frt-m-2 rwt-my-2">
                                    <div
                                        ...
                                        <div>
                                            <FormControl>
                                                <Input type="number"
                                                       defaultValue={values.video_discount_value}
                                                       placeholder="Value"
                                                       onChange={(e:any) => {
