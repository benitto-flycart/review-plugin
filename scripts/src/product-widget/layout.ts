export function masonryLayout(shadowRoot: ShadowRoot) {
    const elem = shadowRoot.querySelector('.r_pw_g_all_reviews_container') as HTMLElement;
...
export function mosaicLayout(shadowRoot: ShadowRoot) {
    const elem = shadowRoot.querySelector('.r_pw_r_m_all_reviews_container') as HTMLElement;
