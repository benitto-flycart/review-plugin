...
const FLOATING_WIDGET = (jquery: any) => {
    ...
    if (!(window as any).floatingWidgetInitialized) {
        ...
        const productWidget = new ProductWidget(floatingWidget.floatingShadowRoot, jquery);
    ...
    const floatingProductWidgetInstance = (window as any).floatingProductWidgetInstance;
